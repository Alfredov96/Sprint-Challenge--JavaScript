...
const contactInfo = [first_name, email];
var seperate = contactInfo.split('  ')
...
var something = lowCaseAnimalNames.tolowercase()
};
...
*/
const lowPopulationAnimals = [population];
population.filter <= 5;
...
const populationTotal = 0;
  function animal (animal_name, population){
animal_name = [zooAnimals.animal_name];
population = [zooAnimals.population]
  }
  populationTotal = [];
